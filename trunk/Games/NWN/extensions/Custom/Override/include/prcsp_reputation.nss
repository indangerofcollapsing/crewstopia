...
int HandleDispositionALLALLIES(object oTarget, object oSource);
int HandleDispositionSELECTIVEHOSTILE(object oTarget, object oSource);
int HandleDispositionSTANDARDHOSTILE(object oTarget, object oSource);
