...
const int BASE_ITEM_CRAFTED_ROD     = 215; // @DUG 200; // Conflicts with CEP2.2
const int BASE_ITEM_CRAFTED_STAFF   = 216; // @DUG 201; // Conflicts with CEP2.2
const int BASE_ITEM_ELF_LIGHTBLADE  = 217; // @DUG 202; // Conflicts with CEP2.2
const int BASE_ITEM_ELF_THINBLADE   = 218; // @DUG 203; // Conflicts with CEP2.2
const int BASE_ITEM_ELF_COURTBLADE  = 219; // @DUG 204; // Conflicts with CEP2.2
