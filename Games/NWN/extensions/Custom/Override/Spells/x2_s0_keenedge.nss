...
// End of Spell Cast Hook
    ...
    if(GetIsObjectValid(oMyWeapon) )
    {
        ...
        {
// @DUG why discriminate based on weapon type?
SendMessageToPC(OBJECT_SELF, "Your slashing weapon is now keen.");
}
else
{
SendMessageToPC(OBJECT_SELF, "Your non-slashing weapon is now keen.");
}
            if (nDuration>0)
            {
