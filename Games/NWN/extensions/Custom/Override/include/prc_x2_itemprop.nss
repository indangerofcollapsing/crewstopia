...
int IPGetIsMeleeWeapon(object oItem)
{
    ...
    if((nItem == BASE_ITEM_BASTARDSWORD) ||
      ...
      || (nItem == 330) // CEP Longsword_2 // @DUG
      || (nItem == 331) // CEP Shortsword_2 // @DUG
      || (nItem == 332) // CEP Battleaxe_2 // @DUG
      || (nItem == 333) // CEP Bastardsword_2 // @DUG
      || (nItem == 334) // CEP Warhammer_2 // @DUG
      || (nItem == 336) // CEP Mace_2 // @DUG
      || (nItem == 337) // CEP Halberd_2 // @DUG
      || (nItem == 339) // CEP Two_bladed_sword_2 // @DUG
      || (nItem == 340) // CEP Greatsword_2 // @DUG
      || (nItem == 342) // CEP Greataxe_2 // @DUG
      || (nItem == 343) // CEP Rapier_2 // @DUG
      || (nItem == 344) // CEP Scimitar_2 // @DUG
      || (nItem == 347) // CEP Spear_2 // @DUG
      || (nItem == 348) // CEP Dwarven_waraxe_2 // @DUG
      )
   {
        return TRUE;
   }
...
int IPGetItemSequencerProperty(object oItem, object oPC = OBJECT_SELF)
{
// @DUG DoDebug("IPGetItemSequencerProperty() before itemprop loop");
    int nCnt;
...
// @DUG DoDebug("IPGetItemSequencerProperty() returning");
    return nCnt;
}
