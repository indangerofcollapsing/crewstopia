...
int CTG_GetIsWeapon(int nItemBaseType)
{
   return (nItemBaseType == BASE_ITEM_ARROW ||
      ...
      nItemBaseType == BASE_ITEM_DWARVENWARAXE ||
      ...
      nItemBaseType == BASE_ITEM_TRIDENT ||
      nItemBaseType == BASE_ITEM_TWOBLADEDSWORD ||
      nItemBaseType == BASE_ITEM_WARHAMMER ||
      nItemBaseType == BASE_ITEM_WHIP ||
      nItemBaseType == BASE_ITEM_DAGGERASSASSIN ||
      nItemBaseType == BASE_ITEM_DOUBLESCIMITAR ||
      nItemBaseType == BASE_ITEM_FALCHION1 ||
      nItemBaseType == BASE_ITEM_FALCHION2 ||
      nItemBaseType == BASE_ITEM_GOAD ||
      nItemBaseType == BASE_ITEM_HEAVYMACE ||
      nItemBaseType == BASE_ITEM_HEAVYPICK ||
      nItemBaseType == BASE_ITEM_KATAR ||
      nItemBaseType == BASE_ITEM_KUKRI2 ||
      nItemBaseType == BASE_ITEM_LIGHTMACE2 ||
      nItemBaseType == BASE_ITEM_LIGHTPICK ||
      nItemBaseType == BASE_ITEM_MAUL ||
      nItemBaseType == BASE_ITEM_MERCURIALGREATSWORD ||
      nItemBaseType == BASE_ITEM_MERCURIALLONGSWORD ||
      nItemBaseType == BASE_ITEM_NUNCHAKU ||
      nItemBaseType == BASE_ITEM_SAI ||
      nItemBaseType == BASE_ITEM_SAP ||
      nItemBaseType == BASE_ITEM_TRIDENT_1H ||
      nItemBaseType == BASE_ITEM_WINDFIREWHEEL);
}
...
int CTG_GetIsMeleeWeapon(int nItemBaseType)
{
   return (nItemBaseType == BASE_ITEM_BASTARDSWORD ||
      nItemBaseType == BASE_ITEM_BATTLEAXE ||
      nItemBaseType == BASE_ITEM_CLUB ||
      nItemBaseType == BASE_ITEM_DAGGER ||
      nItemBaseType == BASE_ITEM_DIREMACE ||
...
int CTG_GetIsArmor(int nItemBaseType)
{
   return (nItemBaseType == BASE_ITEM_ARMOR ||
      ...
      nItemBaseType == BASE_ITEM_HELMET ||
