...
void GestaltStartCutscene(object oPC, string sName, int bCamera = TRUE, int bClear = TRUE, int bClearFX = TRUE, int bResetSpeed = TRUE, int bStoreCam = TRUE, int iParty = 0)
{
    ...
    SetLocalInt(GetModule(),sName + "time",iCancel);

    while (GetIsObjectValid(oParty))
        {
        SetCutsceneMode(oParty,TRUE);
        SetLocalString(oParty,"cutscene",sName);
        SetLocalInt(oParty,sName + "time",iCancel);
...
void GestaltRegisterActor(string sName, object oActor, string sActor = "")
{
    ...
    string sCancel = IntToString(GetLocalInt(GetModule(),sName + "time"));
...
void GestaltDoStopCutscene(string sName, int iCancel, object oPC, string sDestination = "", int bMode = TRUE, int bCamera = TRUE, int bClear = TRUE, int bClearFX = TRUE, int bResetSpeed = TRUE, int bClearActors = TRUE, int iParty = 0)
{
    ...
    while (GetIsObjectValid(oParty))
        ...
        DeleteLocalInt(oParty,sName + "time");
...
void GestaltStopCutscene(float fDelay, object oPC, string sDestination = "", int bMode = TRUE, int bCamera = TRUE, int bClear = TRUE, int bClearFX = TRUE, int bResetSpeed = TRUE, int bClearActors = TRUE, int iParty = 0)
{
    ...
    int iCancel = GetLocalInt(oPC,sName + "time");
    DelayCommand(fDelay,GestaltDoStopCutscene(sName,iCancel,oPC,sDestination,bMode,bCamera,bClear,bClearFX,bResetSpeed,bClearActors,iParty));
}
...
void GestaltDoClearAssociate(object oAssociate, int iMethod, object oDestination)
{
    ...
    if (iMethod == 0)           { AssignCommand(oAssociate,JumpToObject(oDestination)); }
...
void GestaltClearAssociates(float fDelay, object oPC, int iAssociates = 63, int iMethod = 0, object oDestination = OBJECT_INVALID, string sDestination = "", int iParty = 0)
{
    ...
    while (GetIsObjectValid(oParty))
        {
        DelayCommand(fDelay,GestaltDoClearAssociates(sName,iCancel,oParty,iAssociates,iMethod,oDestination,sDestination));
...
void GestaltReturnAssociates(float fDelay, object oPC, int iAssociates = 63, int iMethod = 0, object oDestination = OBJECT_INVALID, string sDestination = "", int iParty = 0)
{
    ...
    while (GetIsObjectValid(oParty))
        {
        DelayCommand(fDelay,GestaltDoReturnAssociates(sName,iCancel,oParty,iAssociates,iMethod,oDestination,sDestination));
...
void GestaltTagSetSpeed(float fDelay, string sActor, float fTime, float fDistance, int iRun)
{
    ...
    DelayCommand(fDelay,GestaltDoSetSpeed(sName,iCancel,OBJECT_INVALID,sActor,fTime,fDistance,iRun));
}
...
void GestaltSetSpeed(float fDelay, object oActor, float fTime, float fDistance, int iRun)
{
    ...
    DelayCommand(fDelay,GestaltDoSetSpeed(sName,iCancel,oActor,"",fTime,fDistance,iRun));
}
...
void GestaltInvisibility(float fDelay, object oActor, float fTime = 0.0, string sActor = "")
{
    ...
    DelayCommand(fDelay,GestaltDoInvisibility(sName,iCancel,oActor,sActor,fTime));
}
...
void GestaltDoMove(string sName, int iCancel, object oActor, string sActor, object oDestination, int iRun, float fRange, float fTime, string sDestination, int bTowards)
{
    ...
    if (fTime > 0.0)
        { AssignCommand(oActor,ActionDoCommand(GestaltDoSetSpeed(sName,iCancel,oActor,"",fTime,GetDistanceBetween(oActor,oDestination),iRun))); }
...
void GestaltTagActionMove(float fDelay, string sActor, object oDestination, int iRun = FALSE, float fRange = 0.0, float fTime = 0.0, string sDestination = "", int bTowards = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoMove(sName,iCancel,OBJECT_INVALID,sActor,oDestination,iRun,fRange,fTime,sDestination,bTowards));
...
void GestaltActionMove(float fDelay, object oActor, object oDestination, int iRun = FALSE, float fRange = 0.0, float fTime = 0.0, string sDestination = "", int bTowards = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoMove(sName,iCancel,oActor,"",oDestination,iRun,fRange,fTime,sDestination,bTowards));
...
void GestaltTagActionJump(float fDelay, string sActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoJump(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sTarget,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagJump(float fDelay, string sActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoJump(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sTarget));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionJump(float fDelay, object oActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoJump(sName,iCancel,oActor,"",oTarget,sTarget,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltJump(float fDelay, object oActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoJump(sName,iCancel,oActor,"",oTarget,sTarget));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionAnimate(float fDelay, string sActor, int iAnim, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoAnimate(sName,iCancel,OBJECT_INVALID,sActor,iAnim,fDuration,fSpeed,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagAnimate(float fDelay, string sActor, int iAnim, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoAnimate(sName,iCancel,OBJECT_INVALID,sActor,iAnim,fDuration,fSpeed));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionAnimate(float fDelay, object oActor, int iAnim, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoAnimate(sName,iCancel,oActor,"",iAnim,fDuration,fSpeed,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltAnimate(float fDelay, object oActor, int iAnim, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoAnimate(sName,iCancel,oActor,"",iAnim,fDuration,fSpeed));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionSpeak(float fDelay, string sActor, string sLine, int iAnimation = ANIMATION_NONE, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoSpeak(sName,iCancel,OBJECT_INVALID,sActor,sLine,iAnimation,fDuration,fSpeed,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagSpeak(float fDelay, string sActor, string sLine, int iAnimation = ANIMATION_NONE, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoSpeak(sName,iCancel,OBJECT_INVALID,sActor,sLine,iAnimation,fDuration,fSpeed));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionSpeak(float fDelay, object oActor, string sLine, int iAnimation = ANIMATION_NONE, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoSpeak(sName,iCancel,oActor,"",sLine,iAnimation,fDuration,fSpeed,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltSpeak(float fDelay, object oActor, string sLine, int iAnimation = ANIMATION_NONE, float fDuration = 0.0, float fSpeed = 1.0)
{
    ...
    DelayCommand(fDelay,GestaltDoSpeak(sName,iCancel,oActor,"",sLine,iAnimation,fDuration,fSpeed));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltActionConversation(float fDelay, object oActor, object oTarget, string sConv = "", string sTarget = "", int bGreet = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoConversation(sName,iCancel,oActor,"",oTarget,sConv,sTarget,bGreet));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionConversation(float fDelay, string sActor, object oTarget, string sConv = "", string sTarget = "", int bGreet = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoConversation(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sConv,sTarget,bGreet));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagActionFace(float fDelay, string sActor, float fFace, int iFace = 0, object oTarget = OBJECT_INVALID)
{
    ...
    DelayCommand(fDelay,GestaltDoFace(sName,iCancel,OBJECT_INVALID,sActor,oTarget,iFace,fFace,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagFace(float fDelay, string sActor, float fFace, int iFace = 0, object oTarget = OBJECT_INVALID)
{
    ...
    DelayCommand(fDelay,GestaltDoFace(sName,iCancel,OBJECT_INVALID,sActor,oTarget,iFace,fFace,FALSE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionFace(float fDelay, object oActor, float fFace, int iFace = 0, object oTarget = OBJECT_INVALID)
{
    ...
    DelayCommand(fDelay,GestaltDoFace(sName,iCancel,oActor,"",oTarget,iFace,fFace,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltFace(float fDelay, object oActor, float fFace, int iFace = 0, object oTarget = OBJECT_INVALID)
{
    ...
    DelayCommand(fDelay,GestaltDoFace(sName,iCancel,oActor,"",oTarget,iFace,fFace,FALSE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionEquip(float fDelay, string sActor, int iSlot = INVENTORY_SLOT_BEST_MELEE, object oItem = OBJECT_INVALID, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoEquip(sName,iCancel,OBJECT_INVALID,sActor,iSlot,oItem,sItem));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionEquip(float fDelay, object oActor, int iSlot = INVENTORY_SLOT_BEST_MELEE, object oItem = OBJECT_INVALID, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoEquip(sName,iCancel,oActor,"",iSlot,oItem,sItem));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionUnequip(float fDelay, string sActor, int iSlot = INVENTORY_SLOT_NONE, object oItem = OBJECT_INVALID, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoUnequip(sName,iCancel,OBJECT_INVALID,sActor,iSlot,oItem,sItem));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionUnequip(float fDelay, object oActor, int iSlot = INVENTORY_SLOT_NONE, object oItem = OBJECT_INVALID, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoUnequip(sName,iCancel,oActor,"",iSlot,oItem,sItem));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionAttack(float fDelay, string sActor, object oTarget, string sTarget = "", int bPassive = FALSE)
{
    ...
    DelayCommand(fDelay,GestaltDoAttack(sName,iCancel,OBJECT_INVALID,sActor,oTarget,bPassive,sTarget));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionAttack(float fDelay, object oActor, object oTarget, string sTarget = "", int bPassive = FALSE)
{
    ...
    DelayCommand(fDelay,GestaltDoAttack(sName,iCancel,oActor,"",oTarget,bPassive,sTarget));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltActionSpellCast(float fDelay, object oActor, object oTarget, int iSpell, int bFake = FALSE, int iPath = PROJECTILE_PATH_TYPE_DEFAULT, string sTarget = "", int bCheat = TRUE, int bInstant = FALSE, int iLevel = 0, int iMeta = METAMAGIC_NONE)
{
    ...
    DelayCommand(fDelay,GestaltDoSpellCast(sName,iCancel,oActor,"",oTarget,iSpell,bFake,iPath,sTarget,bCheat,bInstant,iLevel,iMeta));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionSpellCast(float fDelay, string sActor, object oTarget, int iSpell, int bFake = FALSE, int iPath = PROJECTILE_PATH_TYPE_DEFAULT, string sTarget = "", int bCheat = TRUE, int bInstant = FALSE, int iLevel = 0, int iMeta = METAMAGIC_NONE)
{
    ...
    DelayCommand(fDelay,GestaltDoSpellCast(sName,iCancel,OBJECT_INVALID,sActor,oTarget,iSpell,bFake,iPath,sTarget,bCheat,bInstant,iLevel,iMeta));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltApplyEffect(float fDelay, object oTarget, effect eFect, int iDuration = PERMANENT, float fDuration = 0.0, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoEffect(sName,iCancel,OBJECT_INVALID,"",oTarget,sTarget,eFect,iDuration,fDuration));
}
...
void GestaltActionEffect(float fDelay, object oActor, object oTarget, effect eFect, int iDuration = PERMANENT, float fDuration = 0.0, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoEffect(sName,iCancel,oActor,"",oTarget,sTarget,eFect,iDuration,fDuration,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionEffect(float fDelay, string sActor, object oTarget, effect eFect, int iDuration = PERMANENT, float fDuration = 0.0, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoEffect(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sTarget,eFect,iDuration,fDuration,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionCreate(float fDelay, object oActor, object oTarget, int iType, string sRef, string sTag = "", int iAnim = FALSE, int iStack = 0, int bCreateOn = FALSE, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoCreate(sName,iCancel,oActor,"",oTarget,sTarget,iType,sRef,sTag,iAnim,iStack,bCreateOn,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionCreate(float fDelay, string sActor, object oTarget, int iType, string sRef, string sTag = "", int iAnim = FALSE, int iStack = 0, int bCreateOn = FALSE, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoCreate(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sTarget,iType,sRef,sTag,iAnim,iStack,bCreateOn,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltCreate(float fDelay, object oTarget, int iType, string sRef, string sTag = "", int iAnim = FALSE, int iStack = 0, int bCreateOn = FALSE, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoCreate(sName,iCancel,OBJECT_INVALID,"",oTarget,sTarget,iType,sRef,sTag,iAnim,iStack,bCreateOn));
}
...
void GestaltCopy(float fDelay, object oSource, object oTarget, int bCreateOn = FALSE, string sTag = "", string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoCopy(sName,iCancel,oSource,oTarget,sTarget,sTag,bCreateOn));
}
...
void GestaltDoClone(string sName, int iCancel, object oPC, object oTarget, string sTarget, string sTag, int bInvisible)
{
    ...
    if (sTarget != "")  { oTarget = GetObjectByTag(sTarget); }
    CopyObject(oPC,GetLocation(oTarget),OBJECT_INVALID,sTag);
...
void GestaltClonePC(float fDelay, object oPC, object oTarget, string sTag = "cloned_pc", string sTarget = "", int bInvisible = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoClone(sName,iCancel,oPC,oTarget,sTarget,sTag,bInvisible));
}
...
void GestaltTagActionPickUp(float fDelay, string sActor, object oItem, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoPickUp(sName,iCancel,OBJECT_INVALID,sActor,oItem,sItem));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionPickUp(float fDelay, object oActor, object oItem, string sItem = "")
{
    ...
    DelayCommand(fDelay,GestaltDoPickUp(sName,iCancel,oActor,"",oItem,sItem));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionSit(float fDelay, string sActor, object oChair, string sChair = "")
{
    ...
    DelayCommand(fDelay,GestaltDoSit(sName,iCancel,OBJECT_INVALID,sActor,oChair,sChair));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionSit(float fDelay, object oActor, object oChair, string sChair = "")
{
    ...
    DelayCommand(fDelay,GestaltDoSit(sName,iCancel,oActor,"",oChair,sChair));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltPlaySound(float fDelay, object oActor, string sSound, string sActor = "")
{
    ...
    DelayCommand(fDelay,GestaltDoPlaySound(sName,iCancel,oActor,sActor,sSound,FALSE));
...
void GestaltActionPlaySound(float fDelay, object oActor, string sSound, string sActor = "")
{
    ...
    DelayCommand(fDelay,GestaltDoPlaySound(sName,iCancel,oActor,sActor,sSound,TRUE));
...
void GestaltDoSoundObject(string sName, int iCancel, object oSound, int bOn, float fDuration, int iVolume, object oPosition)
{
    ...
    if (fDuration > 0.0)                { DelayCommand(fDuration,GestaltDoSoundObject(sName,iCancel,oSound,!bOn,0.0,128,OBJECT_INVALID)); }
...
void GestaltSoundObject(float fDelay, object oSound, int bOn = TRUE, float fDuration = 0.0, int iVolume = 128, object oPosition = OBJECT_INVALID)
{
    ...
    DelayCommand(fDelay,GestaltDoSoundObject(sName,iCancel,oSound,bOn,fDuration,iVolume,oPosition));
}
...
void GestaltDoAmbientSound(string sName, int iCancel, object oArea, int bOn, float fDuration, int iVolume)
{
    ...
    if (fDuration > 0.0)                { DelayCommand(fDuration,GestaltDoAmbientSound(sName,iCancel,oArea,!bOn,0.0,128)); }
...
void GestaltAmbientSound(float fDelay, object oArea, int bOn = TRUE, float fDuration = 0.0, int iVolume = 128)
{
    ...
    DelayCommand(fDelay,GestaltDoAmbientSound(sName,iCancel,oArea,bOn,fDuration,iVolume));
}
...
void GestaltDoMusic(string sName, int iCancel, object oArea, int bOn = TRUE, int iTrack = TRACK_CURRENT, float fDuration = 0.0)
{
    ...
    if (fDuration > 0.0)                { DelayCommand(fDuration,GestaltDoMusic(sName,iCancel,oArea,!bOn,iTrack)); }
...
void GestaltPlayMusic(float fDelay, object oArea, int bOn = TRUE, int iTrack = TRACK_CURRENT, float fDuration = 0.0)
{
    ...
    DelayCommand(fDelay,GestaltDoMusic(sName,iCancel,oArea,bOn,iTrack,fDuration));
}
...
void GestaltActionClose(float fDelay, object oActor, object oDoor, int bLock = FALSE)
{
    ...
    DelayCommand(fDelay,GestaltDoDoor(sName,iCancel,oActor,"",oDoor,bLock,FALSE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltActionOpen(float fDelay, object oActor, object oDoor, int bUnlock = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoDoor(sName,iCancel,oActor,"",oDoor,bUnlock,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionClose(float fDelay, string sActor, object oDoor, int bLock = FALSE)
{
    ...
    DelayCommand(fDelay,GestaltDoDoor(sName,iCancel,OBJECT_INVALID,sActor,oDoor,bLock,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltTagActionOpen(float fDelay, string sActor, object oDoor, int bUnlock = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoDoor(sName,iCancel,OBJECT_INVALID,sActor,oDoor,bUnlock,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltJournalEntry(float fDelay, object oPC, string sQuest, int iState, int iXP = 0, int iParty = 0, int bRewardAll = TRUE, int bOverride = FALSE)
{
    ...
    DelayCommand(fDelay,GestaltDoQuest(sName,iCancel,oPC,sQuest,iState,iXP,iParty,bRewardAll,bOverride));
}
...
void GestaltTagActionWait(float fDelay, string sActor, float fPause)
{
    ...
    DelayCommand(fDelay,GestaltDoWait(sName,iCancel,OBJECT_INVALID,sActor,fPause));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltActionWait(float fDelay, object oActor, float fPause)
{
    ...
    DelayCommand(fDelay,GestaltDoWait(sName,iCancel,oActor,"",fPause));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltClearActions(float fDelay, object oActor, string sActor="")
{
    ...
    DelayCommand(fDelay,GestaltDoClear(sName,iCancel,oActor,sActor));
}
...
void GestaltFloatingText(float fDelay, object oActor, string sMessage, int bFaction = TRUE)
{
    ...
    DelayCommand(fDelay,GestaltDoFloatingText(sName,iCancel,oActor,sMessage,bFaction));
}
...
void GestaltExecuteScript(float fDelay, object oTarget, string sScript, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoExecute(sName,iCancel,oTarget,sScript,sTarget));
}
...
void GestaltActionExecute(float fDelay, object oActor, object oTarget, string sScript, string sTarget = "")
{
    ...
    DelayCommand(fDelay,AssignCommand(oActor,ActionDoCommand(GestaltDoExecute(sName,iCancel,oTarget,sScript,sTarget))));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltActionDestroy(float fDelay, object oActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoDestroy(sName,iCancel,oActor,"",oTarget,sTarget,TRUE));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltTagActionDestroy(float fDelay, string sActor, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoDestroy(sName,iCancel,OBJECT_INVALID,sActor,oTarget,sTarget,TRUE));
    GestaltRegisterActor(sName,OBJECT_INVALID,sActor);
}
...
void GestaltDestroy(float fDelay, object oTarget, string sTarget = "")
{
    ...
    DelayCommand(fDelay,GestaltDoDestroy(sName,iCancel,OBJECT_INVALID,"",oTarget,sTarget,FALSE));
}
...
void GestaltCameraMode(float fDelay, object oPC, int iMode)
{
    ...
    DelayCommand(fDelay,GestaltDoCameraMode(sName,iCancel,oPC,iMode));
}
...
void GestaltCameraFacing(float fDelay, float fDirection, float fRange, float fPitch, object oPC, int iTransition = CAMERA_TRANSITION_TYPE_SNAP)
{
    ...
    DelayCommand(fDelay,GestaltDoCameraFacing(sName,iCancel,fDirection,fRange,fPitch,oPC,iTransition));
}
...
void GestaltCameraSetup(float fDelay, object oPC, float fDirection, float fRange, float fPitch, float fHeight = 0.0)
{
    ...
    if (fDelay == 0.0)  { GestaltDoCameraSetup(sName,iCancel,oPC,fDirection,fRange,fPitch,fHeight); }
    else                { DelayCommand(fDelay,GestaltDoCameraSetup(sName,iCancel,oPC,fDirection,fRange,fPitch,fHeight)); }
}
...
void GestaltDoFade(string sName, int iCancel, object oPC, int iFade, float fSpeed, float fDuration, int iParty)
{
    ...
    if (iFade == FADE_IN)
        {
        if (fDuration > 0.0)
            { GestaltDoBlack(sName,iCancel,oPC,iParty); }
        DelayCommand(fDuration,GestaltDoFadeIn(sName,iCancel,oPC,fSpeed,iParty));
        }

    else if (iFade == FADE_OUT)
        {
        GestaltDoFadeOut(sName,iCancel,oPC,fSpeed,iParty);
        if (fDuration > 0.0)
            { DelayCommand(fDuration,GestaltDoStopFade(sName,iCancel,oPC,iParty)); }
        }
...
void GestaltActionCameraFade(float fDelay, object oActor, object oPC, int iFade, float fSpeed = FADE_SPEED_MEDIUM, float fDuration = 0.0, int iParty = 0)
{
    ...
    DelayCommand(fDelay,AssignCommand(oActor,ActionDoCommand(GestaltDoFade(sName,iCancel,oPC,iFade,fSpeed,fDuration,iParty))));
    if (!GetIsPC(oActor))       { GestaltRegisterActor(sName,oActor); }
}
...
void GestaltCameraFade(float fDelay, object oPC, int iFade, float fSpeed = FADE_SPEED_MEDIUM, float fDuration = 0.0, int iParty = 0)
{
    ...
    DelayCommand(fDelay,GestaltDoFade(sName,iCancel,oPC,iFade,fSpeed,fDuration,iParty));
}
