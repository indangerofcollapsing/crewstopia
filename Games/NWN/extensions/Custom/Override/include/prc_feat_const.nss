...
//const int FEAT_DOPP_SHIFT = 1700; // @DUG
//const int FEAT_DOPP_TRUE = 1701; // @DUG
const int FEAT_PRACTISED_SHIFTER = 1702; // @DUG
const int FEAT_AUTOTARGET_NEAREST = 1703; // @DUG
