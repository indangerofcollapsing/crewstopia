...
int StartingConditional()
{
  ...
  int nDiffLawChaos = GetLawChaosValue(oPC)-GetLawChaosValue(OBJECT_SELF);
  int nDiffGoodEvil = GetGoodEvilValue(oPC)-GetGoodEvilValue(OBJECT_SELF);
  int nMaxDiff = OHS_GetMaxAlignmentDifference();
  if ((nDiffLawChaos*nDiffLawChaos+nDiffGoodEvil*nDiffGoodEvil)>(nMaxDiff*nMaxDiff))
  {
    return TRUE;
  }
  else
